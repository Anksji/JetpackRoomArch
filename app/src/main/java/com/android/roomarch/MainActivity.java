...
import com.android.roomarch.ViewModel.NoteViewModel;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_NOTE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Note note = new Note(note_id,
                    data.getStringExtra(AddNoteActivity.NOTE_TITLE),
                    data.getStringExtra(AddNoteActivity.NOTE_CONTENT));
            ...
            Note note = new Note(
                    ...
                    data.getStringExtra(EditNoteActivity.UPDATED_NOTE_CONTENT)
                    );
